...
public class ActivityVehicleDetail extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate ( Bundle savedInstanceState ) {
        ...
        try {
            ...
            vehicleNo = inty.getStringExtra("vehicelNo").trim();
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (jsonObject.getString("status").equals("true")) {
                        ...
                        txtSpeed.setText (jObj.getString ("speed") + "  Km/Hr");
                        ...
                        Toast.makeText ( ActivityVehicleDetail.this , "Plaese enter the valid vehicle number" , Toast.LENGTH_SHORT ).show ( );
                        finish ();
    ...
    protected boolean isConnection() {
        ...
        if (info != null && info.isConnectedOrConnecting()) {
            ...
            Toast.makeText(ActivityVehicleDetail.this, "Please check your internet connection", Toast.LENGTH_LONG).show();
            return false;
        }
    }
