...
public class De_installDeviceModel {
    ...
    public De_installDeviceModel ( String veh_no, String depo, String division, String imieno, String remarks, String instal_time, String instal_date, String lat, String lng, String address) {
        this.veh_no = veh_no;
        this.depo = depo;
